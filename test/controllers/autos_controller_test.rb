...
class AutosControllerTest < ActionController::TestCase
  ...
  test "should create auto" do
    assert_difference('Auto.count') do
      post :create, auto: { class: @auto.class, color: @auto.color, model: @auto.model, number: @auto.number, year: @auto.year }
    end
  ...
  test "should update auto" do
    patch :update, id: @auto, auto: { class: @auto.class, color: @auto.color, model: @auto.model, number: @auto.number, year: @auto.year }
    assert_redirected_to auto_path(assigns(:auto))
  end
